...
class RobustSignalGenerator:
    ...
    DELTA_PARAMS = {
        "rsi": (5, 1.0, 0.05043114777623858),
        "macd_hist": (0.002, 100.0, 0.03942385730558927),
        "ema_diff": (0.001, 100.0, 0.04904598427292712),
        "atr_pct": (0.002, 100.0, 0.037479009379465925),
        "vol_ma_ratio": (0.2, 1.0, 0.04618080097085434),
        "funding_rate": (0.0005, 10000, 0.026829286180939764),
    ...
    def __init__(self, config: RobustSignalGeneratorConfig, *, cache_maxsize: int = DEFAULT_CACHE_MAXSIZE):
        ...
        _base_weights = {
            "ai": 0.11845305856076843,
            "trend": 0.11603421540481929,
            "momentum": 0.2871469576812933,
            "volatility": 0.16620679331752136,
            "volume": 0.055108335793863844,
            "sentiment": 0.08904586584302998,
            "funding": 0.09882896342625411,
        }
